...
public class AdminHelpCommand extends SubCommand {
    ...
    public void perform(CommandSender sender, String[] args) {
        ...
        player.sendMessage("-----(AFKRewards Admin Commands)-----");
        ArrayList<SubCommand> subCommands = AFKRewards.getInstance().getAdminCommandManager().getSubcommands();
