...
import com.github.gavvydizzle.afkrewards.commands.admincommands.*;
...
public class AdminCommandManager implements TabExecutor {
    ...
    public AdminCommandManager() {
        subcommands.add(new AdminBeginAFKCommand());
        subcommands.add(new AdminEndAFKCommand());
        subcommands.add(new AdminHelpCommand());
        subcommands.add(new AdminReloadCommand());
        subcommands.add(new AdminSetGroupRegionCommand());
        subcommands.add(new AdminSetScoreCommand());
        subcommands.add(new AdminValidateRegionCommand());
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, String[] args) {
        ...
        sender.sendMessage(ChatColor.YELLOW + "Use '/afkadmin help' to see a list of valid commands");
